...
public class HttpConnectionManager {
    ...
    static {
        ...
        collection
                .add(new BasicHeader("User-Agent", "Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 5.1; Trident/4.0)"));
    ...
    public String getHtml(String url) {
        ...
        String html = getHtml(url, proxyHost, null);

        int count = 0;
        while (html == null || "".equals(html)) {
            proxyHost = new HttpHost("211.142.236.137", 80);// 更换代理
            html = getHtml(url, proxyHost, null);
            count++;
            if (count > 3) {
     ...
     * @return 页面代码
     */
    public String getHtml(String url, HttpHost proxyHost, String charcoding) {
        String html = "";
        ...
        try {
            ...
            if (httpEntity != null) {
                html = readHtmlContentFromEntity(httpEntity, charcoding);
            }
     ...
     * @throws IOException
     */
    private String readHtmlContentFromEntity(HttpEntity httpEntity, String charcoding) throws ParseException, IOException {
        String html = "";
        ...
        if (httpEntity.getContentLength() < 2147483647L) { // EntityUtils无法处理ContentLength超过2147483647L的Entity
            if (header != null && "gzip".equals(header.getValue())) {
                ...
                if (charcoding != null && !"".equals(charcoding)) {
                    InputStream in = httpEntity.getContent();
                    html = readInStreamToString(in, charcoding);
                } else {
    ...
    public boolean isProxyUsable(HttpHost proxyHost, String url) {
        ...
        try {
            ...
            if (httpEntity != null) {
                String html = readHtmlContentFromEntity(httpEntity, null);
                //System.out.println(html.length());
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Date start = new Date();
        String html = httpConnectionManager.getHtml("http://10.0.0.71:6008/resource/html/201712/html/f6a94068ad19454d901dbe0381d488c8.html", null, "GB2312");
        Date end = new Date();
