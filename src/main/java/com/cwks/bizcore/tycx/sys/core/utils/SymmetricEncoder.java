...
public class SymmetricEncoder {
   ...
   */
    ...
    public static void main(String[] args) {
        ...
        String encodeRules="cwks_mobie";
        System.out.println("请输入要加密的内容:");
        //String content = scanner.next();
        String content="admin_85F830CE-6B6A-4C73-8AD5-A21747C278D6";
        ...
        encodeRules="cwks_mobie";
        System.out.println("请输入要解密的内容（密文）:");
        content = "TGDhWc3/vfX1NMHW/EgXzOEmW6j8t28eKtkUA7sozf3ed8bBm1yoLMEeRM mQFhq";
