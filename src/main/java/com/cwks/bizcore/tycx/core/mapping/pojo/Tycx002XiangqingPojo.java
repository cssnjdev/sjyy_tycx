...
public class Tycx002XiangqingPojo {
    ...
    /**无参构造函数**/
    public Tycx002XiangqingPojo() {
    	
    }

    /**有参构造函数**/
	public Tycx002XiangqingPojo(String banben, String fbrdm, String fbsj,
	...
	public Tycx002XiangqingPojo(Map data){
