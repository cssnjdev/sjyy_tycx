...
@Controller
@RequestMapping("/tycx")
public class TycxController {
	private static Logger logger = LoggerFactory.getLogger(TycxController.class);
	...
	public String model(HttpServletRequest request,
		...
		String path="biz/bizcore/sjyy/tycx/tycx001Cxdy_main";
