var _url = _domain_path+'/mobile/request?tld=pyq001TMbBizAppPyqArticleFjService';
...
var fields = [
    [
        {title:'附件类型代码 01图片02视频',field:'fjlx_dm',sortable:'true', width:100},
        {title:'附件上传名称',field:'fjsc_name',sortable:'true', width:100},
        {title:'附件名称',field:'fj_name',sortable:'true', width:100},
        {title:'附件ID',field:'fj_pkid',sortable:'true', width:100},
        {title:'录入人员代码',field:'lrry_dm',sortable:'true', width:100},
        {title:'录入时间',field:'lr_sj',sortable:'true', width:100},
        {title:'文章主键',field:'pkid',sortable:'true', width:100},
        {title:'原件URL',field:'url_yj',sortable:'true', width:100},
        {title:'原件压缩后URL',field:'url_ys',sortable:'true', width:100},
        {title:'修改人员代码',field:'xgry_dm',sortable:'true', width:100},
        {title:'修改时间',field:'xg_sj',sortable:'true', width:100},
        {title:'序号',field:'xh',sortable:'true', width:100}
    ]
];
        ...
        $.messager.confirm('删除', '您确认要删除？', function(r) {
            if (r) {
                ...
                for ( var i = 0; i < totleRows.length; i++) {
                    fj_pkids.push(totleRows[i].fj_pkid);
                    pkids.push(totleRows[i].pkid);
                }
                $.post(_url_deleteByPKey,{'fj_pkid':fj_pkids,'pkid':pkids}, function(data){
