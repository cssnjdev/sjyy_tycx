var _url = _domain_path+'/mobile/request?tld=pyq001TMbBizAppPyqArticleService';
    ...
    if (selected) {
        ...
        $.messager.confirm('删除', '您确认要删除？', function(r) {
            if (r) {
                ...
                $.post(_url_deleteByPKey,{'pkid':pkids}, function(data){
