var _url = _domain_path+'/mobile/request?tld=pyq001TMbBizAppPyqArticlePlService';
...
var fields = [
    [
        {title:'回复人代码',field:'hfry_dm',sortable:'true', width:100},
        {title:'评论人代码',field:'lrry_dm',sortable:'true', width:100},
        {title:'文章主键',field:'pkid',sortable:'true', width:100},
        {title:'评论标记01评论02回复',field:'pl_bj',sortable:'true', width:100},
        {title:'评论内容（200个字符）',field:'pl_nr',sortable:'true', width:100},
        {title:'评论主键',field:'pl_pkid',sortable:'true', width:100},
        {title:'评论时间',field:'pl_sj',sortable:'true', width:100}
    ]
];
        ...
        $.messager.confirm('删除', '您确认要删除？', function(r) {
            if (r) {
                ...
                for ( var i = 0; i < totleRows.length; i++) {
                    ...
                    pl_pkids.push(totleRows[i].pl_pkid);
                }
                $.post(_url_deleteByPKey,{'pkid':pkids,'pl_pkid':pl_pkids}, function(data){
