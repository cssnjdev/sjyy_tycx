var _url = _cssnj_domain_path+'/tykf/request?tld=tycx001CxCxtjdyService';
...
var colNames = ['DMSQL','FZZDBZ','JGCJ','JGLX','JSSJZD','JYLX','JYS','JYZH','LLX','LMC','LRRQ','LRR_DM','MBBZ','MRZ','MRZXSBZ','SJGSDQ','SJTJL','SM','SQLXH','SWJGTREESCGZ','TJMC','TJXYLX','UUID','XGRQ','XGR_DM','XH','XSGS','XSXH','ZDYCS','ZDYKD','ZNXZ'];

var colModel =

    [
        {name:'dmsql',index:'dmsql', width:100, sorttype:"int" },
        {name:'fzzdbz',index:'fzzdbz', width:100, sorttype:"int" },
        {name:'jgcj',index:'jgcj', width:100, sorttype:"int" },
        {name:'jglx',index:'jglx', width:100, sorttype:"int" },
        {name:'jssjzd',index:'jssjzd', width:100, sorttype:"int" },
        {name:'jylx',index:'jylx', width:100, sorttype:"int" },
        {name:'jys',index:'jys', width:100, sorttype:"int" },
        {name:'jyzh',index:'jyzh', width:100, sorttype:"int" },
        ...
        {name:'mrz',index:'mrz', width:100, sorttype:"int" },
        {name:'mrzxsbz',index:'mrzxsbz', width:100, sorttype:"int" },
        {name:'sjgsdq',index:'sjgsdq', width:100, sorttype:"int" },
        {name:'sjtjl',index:'sjtjl', width:100, sorttype:"int" },
        {name:'sm',index:'sm', width:100, sorttype:"int" },
        {name:'sqlxh',index:'sqlxh', width:100, sorttype:"int" },
        {name:'swjgtreescgz',index:'swjgtreescgz', width:100, sorttype:"int" },
        {name:'tjmc',index:'tjmc', width:100, sorttype:"int" },
        {name:'tjxylx',index:'tjxylx', width:100, sorttype:"int" },
        ...
        {name:'zdycs',index:'zdycs', width:100, sorttype:"int" },
        {name:'zdykd',index:'zdykd', width:100, sorttype:"int" },
        {name:'znxz',index:'znxz', width:100, sorttype:"int" }
    ]
